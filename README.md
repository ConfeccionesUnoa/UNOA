...
```bash
docker exec -it dev-unoa-backend  python manage.py <comando>
```
Ejemplos
```bash
docker exec -it dev-unoa-backend  python manage.py makemigrations
docker exec -it dev-unoa-backend  python manage.py migrate
docker exec -it dev-unoa-backend  python manage.py createsuperuser
```
